                                    ...
                                    <div class="panel-heading">
                                        <h3 class="panel-title">
                                            ...
                                            @if($setting->type == "multiple_images")
                                                <a href="{{ route('voyager.settings.delete_value', $setting->id) }}" class="btn btn-danger delete_value">Delete All</a>
                                            @endif
                                        </h3>
                                                    ...
                                                    @if($images != null)
                                                        @foreach($images as $image)
                                                            <div class="img_settings_container" data-field-name="{{ $setting->key }}" style="float:left;padding-right:15px;">
                                                                ...
                                                                <img src="{{ Voyager::image( $image ) }}" data-file-name="{{ $image }}" data-id="{{ $setting->id }}" style="max-width:200px; height:auto; clear:both; display:block; padding:2px; border:1px solid #ddd; margin-bottom:5px;">
                                                            </div>
                                                        @endforeach
                                                    @endif
                                                @endif
